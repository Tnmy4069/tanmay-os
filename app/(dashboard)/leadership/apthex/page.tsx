...
export default function ApthexPage() {
  return (
    <div className="p-8 max-w-7xl mx-auto space-y-8">
      <div className="flex flex-col gap-2 border-b pb-6">
        ...
        <p className="text-muted-foreground">Manage your Apthex club responsibilities, events, and team coordination.</p>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <Card className="bg-secondary/30">
          <CardHeader className="pb-2"><CardTitle className="text-sm text-muted-foreground uppercase">Team Members</CardTitle></CardHeader>
      ...
      <Card>
        ...
        <CardContent>
          <div className="flex flex-col items-center justify-center py-20 text-center border border-dashed rounded-xl text-muted-foreground gap-3">
            ...
            <p className="text-sm opacity-70">Track Apthex events, meetings, and deliverables here.</p>
          </div>
        </CardContent>
      </Card>
    </div>
